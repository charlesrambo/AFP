...
fundamentals['75'] = fundamentals[['DATE', 'inv_ME_lag']].groupby('DATE')['inv_ME_lag'].quantile(0.75)
...
# drop month column
fundamentals.drop(['month', '75'], axis = 1, inplace = True)
...
# Drop inv_ME_lag from fundamentals
...
# Convert to pandas
fundamentals.to_csv(path + '\\Data\\fundamental_mods\\weekly_fund_rtn_inv_val_wt_cut_' + str(cut) + '.csv', index = False)
